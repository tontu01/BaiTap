        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                <div class="text-center pt-3 pb-3">
                    <h1><strong class="db" style="color: white">SINH VIÊN ĐĂNG NHẬP</strong></h1>
                </div>

                <!-- Form -->
                <form class="form-horizontal mt-3" action="{{ frontendRouter('login.post') }}" method="POST">
                    @csrf
                    ...
                    <div class="row pb-4">
                        <div class="col-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="MaSV" class="form-control form-control-lg"
                                       placeholder="Nhập mã sinh viên" required="" value="{{ old('MaSV') }}">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
