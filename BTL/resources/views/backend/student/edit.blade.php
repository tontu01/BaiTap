                            ...
                            <div id="zero_config_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="card">
                                    <form class="form-horizontal store-update-entity" id="form-text-area"
                                          action="{{backendRouter('student.update', ['id' => $entity->id])}}" method="post"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="MaSV" value="{{ getInputOld(old('MaSV'), $entity->MaSV) }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="TenSV" value="{{ getInputOld(old('TenSV'), $entity->TenSV) }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="QueQuan" value="{{ getInputOld(old('QueQuan'), $entity->QueQuan) }}"
                                                            ...
                                                            <select class="my-select2__select2 select2-wrapper" name="MaLop" required>
                                                                ...
                                                                @foreach($listLop as $item)
                                                                    <option value="{{ arrayGet($item, 'MaLop') }}"
                                                                            {{ getInputOld(old('MaLop'), $entity->MaLop) == arrayGet($item, 'MaLop') ? "selected" : '' }}>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="my-select2__select2 select2-wrapper" name="GioiTinh" required>
                                                                <option value="1" {{ getInputOld(old('GioiTinh'), $entity->GioiTinh) == 1 ? "selected" : "" }}>Nam</option>
                                                                <option value="2" {{ getInputOld(old('GioiTinh'), $entity->GioiTinh) == 2 ? "selected" : "" }}>Nữ</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="date" class="form-control" required name="NgaySinh"
                                                                   value="{{ getInputOld(old('NgaySinh'), $entity->NgaySinh) }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label for="new_title"
                                                               class="col-md-2 text-right control-label col-form-label">Mật khẩu *</label>
                                                        <div class="col-md-8">
                                                            <input type="password" class="form-control" name="MatKhau" value="" placeholder="*****">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
