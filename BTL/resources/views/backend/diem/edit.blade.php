                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-body__head d-flex">
                                ...
                                <a href="{{backendRouter('diem.list')}}">
                            ...
                            <div id="zero_config_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="card">
                                    <form class="form-horizontal store-update-entity" id="form-text-area"
                                          action="{{backendRouter('diem.update', ['id' => $entity->id])}}" method="post"
                                            ...
                                            <div class="row">
                                                            ...
                                                            <select class="my-select2__select2 select2-wrapper" name="MaSV" required>
                                                                ...
                                                                @foreach($listSV as $item)
                                                                    <option value="{{ arrayGet($item, 'MaSV') }}"
                                                                            {{ $entity->MaSV == arrayGet($item, 'MaSV') ? "selected" : '' }}>
                                                                        {{ arrayGet($item, 'TenSV') }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                            ...
                                                            <select class="my-select2__select2 select2-wrapper" name="MaMH" required>
                                                                ...
                                                                @foreach($listMonHoc as $item)
                                                                    <option value="{{ arrayGet($item, 'MaMH') }}"
                                                                            {{ $entity->MaMH == arrayGet($item, 'MaMH') ? "selected" : '' }}>
                                                                        {{ arrayGet($item, 'TenMH') }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select class="my-select2__select2 select2-wrapper" name="HocKy" required>
                                                                <option value="1" {{ $entity->HocKy == 1 ? "selected" : "" }}>1</option>
                                                                <option value="2" {{ $entity->HocKy == 2 ? "selected" : "" }}>2</option>
                                                                <option value="Hè" {{ $entity->HocKy == 'Hè' ? "selected" : "" }}>Hè</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="number" min="0" max="10" class="form-control" required
                                                                   name="Diem" value="{{ $entity->Diem }}" placeholder="Nhập điểm">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
